...
public class BankSelectCustomerActivity extends BaseActivity {
    private static final String TAG = "BankSelectCustomerActivity";
    ...
    private void initToolbar() {
        ...
        tv_title.setText(getStrings(R.string.toolbar_CustomerList));
    }
    ...
    public void onAfterViews() {
        mContext = BankSelectCustomerActivity.this;
    ...
    private void initFragment() {
        ...
        leftBundle.putBoolean(AppDelegate.BANKSLIP_LIST_TYPE ,true);
    ...
    private void initBroadcastReceiver() {
        ...
        intentFilter.addAction(AppDelegate.CUSTOMER_DRAWER_SCREEN); //筛选广播
    ...
    void DoCustomerList() {
        final String url = MoreUserDal.GetServerUrl() + "/api/platformAccount/Accounts?status=2&pageIndex=" + pageIndex + ARGUMENTS;
            ...
            public ViewHolder(View itemView) {
                ...
                ll_content.setOnClickListener(new NoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        ...
                        intent.putExtra("accountId", entity.getId());
                        intent.putExtra("accountName", entity.getName());
                        intent.putExtra("accountCode", entity.getCode());
