...
public class PaymentNewMethodActivity extends BaseActivity {
    private Context mContent;
    private LinearLayoutManager mLinearLayoutManager;
    private TypeItemAdapter mAdapter;
    private PaymentDataEntity.PaymentMethodList Method;
    ...
    public void onAfterViews() {
        mContent = PaymentNewMethodActivity.this;
        initToolbar();
        Method = (PaymentDataEntity.PaymentMethodList) getIntent().getSerializableExtra(AppDelegate.PYNEW_METHOD);
        methodList = (List<PaymentDataEntity.PaymentMethodList>) getIntent().getSerializableExtra(AppDelegate.PYNEW_METHODLIST);
        ...
        mAdapter = new TypeItemAdapter(methodList);
        mRecycler.setAdapter(mAdapter);
        super.onAfterViews();
    }

    public class TypeItemAdapter extends RecyclerView.Adapter<TypeItemAdapter.ViewHolder> {
        private List<PaymentDataEntity.PaymentMethodList> typeList;

        public TypeItemAdapter(List<PaymentDataEntity.PaymentMethodList> typeList) {
        ...
        public void onBindViewHolder(TypeItemAdapter.ViewHolder holder, int position) {
            PaymentDataEntity.PaymentMethodList entity = typeList.get(position);
            holder.name.setText(entity.getName());
            if (Method.getName().equals(entity.getName()))
            ...
            public ViewHolder(View itemView) {
                ...
                item.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        PaymentDataEntity.PaymentMethodList entity = typeList.get(getLayoutPosition());
                        Intent intent = getIntent();
                        intent.putExtra(AppDelegate.PYNEW_METHOD, entity);
