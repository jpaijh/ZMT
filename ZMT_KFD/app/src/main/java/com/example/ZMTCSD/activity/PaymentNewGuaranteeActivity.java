...
public class PaymentNewGuaranteeActivity extends BaseActivity {
    private Context mContent;
    private LinearLayoutManager mLinearLayoutManager;
    private TypeItemAdapter mAdapter;
    private List<PaymentDataEntity.GuaranteeTypeList> guaranteeTypeList;
    private PaymentDataEntity.GuaranteeTypeList Guarantee;
    ...
    private void initToolbar() {
        ...
        tv_title.setText(getStrings(R.string.toolbar_paymentNewGuarantee));
    }

    @Override
    public void onAfterViews() {
        mContent = PaymentNewGuaranteeActivity.this;
        initToolbar();
        Guarantee = (PaymentDataEntity.GuaranteeTypeList) getIntent().getSerializableExtra(AppDelegate.PYNEW_GUARANTEETYPE);
        guaranteeTypeList = (List<PaymentDataEntity.GuaranteeTypeList>) getIntent().getSerializableExtra(AppDelegate.PYNEW_GUARANTEETYPELIST);
        ...
        mAdapter = new TypeItemAdapter(guaranteeTypeList);
        mRecycler.setAdapter(mAdapter);
        super.onAfterViews();
    }

    public class TypeItemAdapter extends RecyclerView.Adapter<TypeItemAdapter.ViewHolder> {
        private List<PaymentDataEntity.GuaranteeTypeList> typeList;

        public TypeItemAdapter(List<PaymentDataEntity.GuaranteeTypeList> typeList) {
        ...
        public void onBindViewHolder(TypeItemAdapter.ViewHolder holder, int position) {
            PaymentDataEntity.GuaranteeTypeList entity = typeList.get(position);
            holder.name.setText(entity.getName());
            if (Guarantee.getName().equals(entity.getName()))
            ...
            public ViewHolder(View itemView) {
                ...
                item.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        PaymentDataEntity.GuaranteeTypeList entity = typeList.get(getLayoutPosition());
                        Intent intent = getIntent();
                        intent.putExtra(AppDelegate.PYNEW_GUARANTEETYPE, entity);
