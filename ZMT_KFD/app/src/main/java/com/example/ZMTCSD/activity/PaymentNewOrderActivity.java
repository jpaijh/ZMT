...
public class PaymentNewOrderActivity extends BaseActivity {
    private static final String TAG = "PaymentNewOrderActivity";
    ...
    private List<PaymentFinanceOrderEntity> rowsEntity;
    ...
    private void initToolbar() {
        ...
        tv_title.setText(getStrings(R.string.toolbar_PaymentFinanceOrder));
    }
    ...
    public void onAfterViews() {
        mContext = PaymentNewOrderActivity.this;
        mRequestQueue = Volley.newRequestQueue(mContext);
        initToolbar();
        AccountId = getIntent().getIntExtra(AppDelegate.PYNEW_CUSTOMERID, -1);
        OrderId = getIntent().getIntExtra(AppDelegate.PYNEW_COMPANYID, -1);
    ...
    void DoOrderList() {
        //http://183.129.133.147:10086/api/payment/paymentFinancialOrders?accountId=3618402
        final String url = MoreUserDal.GetServerUrl() + "/api/payment/paymentFinancialOrders?accountId=" + AccountId + ARGUMENTS;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, new Response.Listener<org.json.JSONObject>() {
            ...
            public void onResponse(org.json.JSONObject response) {
                ...
                if (total != 0 && pageIndex == 1) {
                    ...
                    rowsEntity = JSON.parseArray(rows.toString(), PaymentFinanceOrderEntity.class);
                    ...
                    JSONArray rows = jsonObject.getJSONArray("rows");
                    rowsEntity.addAll(lastVisibleItem + 1, JSON.parseArray(rows.toString(), PaymentFinanceOrderEntity.class));
    ...
    public class PaymentOrderAdapter extends RecyclerView.Adapter<PaymentOrderAdapter.ViewHolder> {
        private List<PaymentFinanceOrderEntity> OrderList;

        public PaymentOrderAdapter(List<PaymentFinanceOrderEntity> orderList) {
            OrderList = orderList;
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            PaymentFinanceOrderEntity entity = OrderList.get(position);
            holder.name.setText(StringUtil.StringToNull(entity.getOrderCode()));
            holder.status.setText(getStrings(R.string.Payment_newFinance_four) + " " + StringUtil.numberDecimal(entity.getPaymentAmount()));
            if (OrderId == entity.getOrderId())
            ...
            public ViewHolder(View itemView) {
                ...
                ll_content.setOnClickListener(new NoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        PaymentFinanceOrderEntity entity = OrderList.get(getLayoutPosition());
                        Intent intent = getIntent();
                        intent.putExtra(AppDelegate.PYNEW_FINANCE_ORDERENTITY, entity);
