...
public class PaymentNewCompanysActivity extends BaseActivity {
    private static final String TAG = "PaymentNewCompanysActivity";
    private RequestQueue mRequestQueue;
    private Context mContext;
    private static final String COMPANY = "company";
    private int companyId; //是选择收款单位的id,为了显示你选择的是那个收款单位
    private int accountId;//是从待客提款传来的，客户没有变就不会变
    ...
    public void onAfterViews() {
        mContext = PaymentNewCompanysActivity.this;
        mRequestQueue = Volley.newRequestQueue(mContext);
        initToolbar();
        accountId = getIntent().getIntExtra(AppDelegate.PYNEW_CUSTOMERID, -1);
        companyId = getIntent().getIntExtra(AppDelegate.PYNEW_COMPANYID,0);
        LogUtils.e(accountId + "：收款单位界面：" + companyId);
    ...
    private void initFragment() {
        ...
        bundle.putString(AppDelegate.PYNEW_SELECT_TYPE, COMPANY);
    ...
    private void initBroadcastReceiver() {
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(AppDelegate.PAYMENT_NEW_SELECTOR) && intent.getStringExtra(AppDelegate.PYNEW_SELECT_TYPE).equals(COMPANY)) {
                    ARGUMENTS = intent.getStringExtra(AppDelegate.PAYMENT_LIST_SCREEN);
                    LogUtils.d("待客提款的收款单位广播" + ARGUMENTS);
    ...
    void DoCustomerList() {
        //http://183.129.133.147:10086/api/payment/Companys?accountId=4900700&pageIndex=1&pageSize=20
        final String url = MoreUserDal.GetServerUrl() + "/api/payment/Companys?pageSize=20&accountId=" + accountId + "&pageIndex=" + pageIndex + ARGUMENTS;
        LogUtils.d("待客提款的 收款单位" + url);
    ...
    public class CustomerListAdapter extends RecyclerView.Adapter<CustomerListAdapter.ViewHolder> {
        ...
        public CustomerListAdapter(List<CompanyListEntity> list) {
            this.list = list;
        }
            ...
            public ViewHolder(View itemView) {
                ...
                ll_content.setOnClickListener(new NoDoubleClickListener() {
                    ...
                    public void onNoDoubleClick(View v) {
                        ...
                        intent.putExtra(AppDelegate.PYNEW_COMPANYENTITY, entity);
